...
import com.example.moviesapplication.models.movieslist.MovieData
import com.example.moviesapplication.views.MoviesDetailActivity
...
class MoviesAdapter : RecyclerView.Adapter<MoviesAdapter.MoviesViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MoviesViewHolder, position: Int) {
        ...
        holder.rating.text = movie?.imdb_rating.toString()
    ...
    fun setData(moviesList: List<MovieData>, context: Context) {
